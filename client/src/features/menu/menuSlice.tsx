...
export const createMenu = createAsyncThunk( "menu/createMenu", async ( body : any, thunkAPI) => {
    try {
      ...
      const { data } = await axios.post(`https://fullstack-cinema-app-1.onrender.com/api/cinema/v1/menus/`, body , config);
        console.log(data);
...
export const getAllMenus = createAsyncThunk( "menu/getAllMenus", async ( _, thunkAPI) => {
    try {
      ...
      const { data } = await axios.get(`https://fullstack-cinema-app-1.onrender.com/api/cinema/v1/menus/` , config);
        console.log(data);
...
export const updateMenu = createAsyncThunk( "menu/updateMenu", async ( {id, body}: {id: string, body:any}, thunkAPI) => {
    try {
      ...
      const { data } = await axios.patch(`https://fullstack-cinema-app-1.onrender.com/api/cinema/v1/menus/${id}`, body , config);
...
export const deleteMenu = createAsyncThunk( "menu/deleteMenu", async ( id: string, thunkAPI) => {
    try {
      ...
      const { data } = await axios.delete(`https://fullstack-cinema-app-1.onrender.com/api/cinema/v1/menus/${id}` , config);
