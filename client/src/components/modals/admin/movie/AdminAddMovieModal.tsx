...
const AdminAddMovieModal = () => {
  ...
  const handleSubmit = () => {
    ...
    if (body.title && body.description && body.photo && body.genre && body.duration && body.releaseDate) {
        dispatch(addMovie(body) as any);
    }
}
      ...
      >
        <div className="content">
            ...
            <div className="input-container">
                ...
                <InputNumber data={data.duration || 0} setData={(e) => handleChange(e)} name="duration" labelText="Film Süresi (Dakika)" width="100%" height="45px" />
